export const bigFiveQuestions = [
  {
    ...
    options: [
      {
        text: "Try unconventional methods and experiment freely",
        value: "openness-high",
        trait: "Openness",
        score: 3
      },
      {
        text: "Follow proven techniques with some personal touches",
        value: "openness-moderate",
        trait: "Openness",
        score: 2
      },
      {
        text: "Stick to traditional methods that work well",
        value: "openness-low",
        trait: "Openness",
        score: 1
      }
  ...
  // Add 14 more questions covering all Big Five traits...
];
